...
# Code that is used to resample datasets according to a specified resampling factor
...
def save_nii(image, curr_nii_loc, res_factor_used):
    ...
    save_folder = os.path.join(*curr_nii_loc.replace("Ergo_data_sample_Res1", "Ergo_data_Res" + str(res_factor_used)).split(os.sep)[:-1])
...
if __name__ == '__main__':
    data_location = "C:/Users/s145576/Documents/.Koen de Raad/year19.20/Thesis/Erasmus MC/Data/Ergo_data_sample_Res1"
