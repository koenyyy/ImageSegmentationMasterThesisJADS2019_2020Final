...
# Code that merges the different classes from the ERGO dataset into one single class instead of 4 seperate ones
...
if __name__ == '__main__':
    data_loc = "C:/Users/s145576/Documents/.Koen de Raad/year19.20/Thesis/Erasmus MC/Data/Ergo_data_sample"
