...
# Script that generates a bunch of commands based on the preprocessing steps defined
# that can be executed on the GPU cluster.
...
def create_run_command(train_config):
    ...
    base_cmd = base_cmd.format(dataset, norm_method, use_otsu, use_BC, res_factor, seed)
    return base_cmd
...
if __name__ == '__main__':
    ...
    train_config_loc = 'C:/Users/s145576/Documents/GitHub/master_thesis/glassimaging-master/config/train_unet.json'
    eval_config_loc = 'C:/Users/s145576/Documents/GitHub/master_thesis/glassimaging-master/config/eval_unet.json'
