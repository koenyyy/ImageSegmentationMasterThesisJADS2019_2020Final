...
# An alternative method for bias correction that can be run on PC. We do not reccommend that this is
# ran as the images may contain large float intensities that can mess up the training process
...
def correct_dataset():
    ...
    for file in lstFilesGz:
        ...
        print('direction:', img.GetDirection(), 'origin:', img.GetOrigin(), 'pix id:', img.GetPixelIDTypeAsString(),
              'spacing:', img.GetSpacing(), 'size:', img.GetSize())
