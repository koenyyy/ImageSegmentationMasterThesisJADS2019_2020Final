...
from glassimaging.training.get_heatmap import get_heatmap
...
class StandardEvaluator:
    ...
    def segmentWholeArray(self, input_array, inputsize, targetsize):
        ...
        heat_me_output = np.zeros(input_array.shape[0:1] + input_array.shape[2:5])
    ...
    def segmentNifti(self, images, header_files, inputsize, savepaths, crop=0):
